  <div class="content-wrapper">
  	...
  	<section class="content">
  		<div class="container-fluid">
            ...
            <form id="addPostingan" class="form" action="<?=base_url()?>admin/posts/add_proc" method="POST" enctype="multipart/form-data">
              <div class="form-group">
                <div class="input-group input-group mb-3">
                  <div class="input-group-prepend">
                    <span class="input-group-text" id="basic-addon1">Judul Artikel</span>
                  </div>
                  <input type="text" class="form-control" name="judul_posting" value="<?=$this->session->flashdata('judul_posting');?>" aria-label="judul_posting" aria-describedby="basic-addon1">
                </div>
              </div>
              <div class="form-group">
                <div class="input-group input-group mb-3">
              ...
              <div class="form-group">
                <textarea id="desc_post" name="deskripsi_posting"><?=$this->session->flashdata('deskripsi_posting');?></textarea>
              </div>
            </form>
  				</div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer justify-content-between">
          ...
          <button type="submit" form="addPostingan" class="btn btn-primary">Tambah</button>
        </div>
      </div>
      <!-- /.modal-content -->
    </div>
