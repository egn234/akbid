  <div class="content-wrapper" style="margin-top: 49px">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Edit Publikasi</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?=base_url()?>admin/dashboard">Home</a></li>
              <li class="breadcrumb-item"><a href="<?=base_url()?>admin/publikasi/list">Publikasi</a></li>
              <li class="breadcrumb-item"><a href="<?=base_url()?>admin/publikasi/detail/<?=$editPub->publikasi_id?>">Detail Publikasi</a></li>
      ...
      <div class="container-fluid">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <form id="editPub" class="form-horizontal" action="<?=base_url()?>admin/publikasi/edit_proc/<?=$editPub->publikasi_id?>" method="POST" enctype="multipart/form-data">
              <div class="form-group">
                <label for="l_nama">Judul Publikasi</label><span class="text-danger">*</span>
                <input id="l_nama" type="text" name="judul_publikasi" class="form-control" value="<?=$editPub->judul_publikasi?>" required>
              </div>
              <div class="form-group">
          ...
          <div class="card-footer">
            <a href="<?=base_url()?>admin/publikasi/detail/<?=$editPub->publikasi_id?>" class="btn btn-default">Kembali</a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer justify-content-between">
        ...
        <button type="submit" form="editPub" class="btn btn-primary">Simpan</button>
      </div>
    </div>
    <!-- /.modal-content -->
  </div>
