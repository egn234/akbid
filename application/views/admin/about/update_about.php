		...
		<div class="container-fluid">
			<div class="card">
				...
				<div class="card-header">
					<h3 class="card-title">Edit Data About</h3>
				</div>
				<!-- /.card-header -->
				<div class="card-body">
					<form class="form-horizontal" method="POST" action="<?= base_url(); ?>admin/about/edit_about" enctype="multipart/form-data">
						<div class="card-body">
							<div class="form-group row">
								<label class="col-sm-2 col-form-label">Judul About :</label>
								<div class="col-sm-10">
									<input class="form-control" id="nofak" type="hidden" value="<?= $data[0]->about_id ?>" name="about_id" required>
									<input class="form-control" id="nofak" type="text" value="<?= $data[0]->judul_about ?>" name="judul_about" required>
								</div>
							</div>
							<div class="form-group row">
								<label class="col-sm-2 col-form-label">Deskripsi About :</label>
								<div class="col-sm-10">
									<textarea id="desc_about" name="deskripsi_about" required><?= $data[0]->deskripsi_about ?></textarea>
								</div>
							</div>
							<div class="form-group row">
				...
				<div class="card-footer">
					...
					<a href="<?= base_url(); ?>admin/about/detail_about?id=<?= $data[0]->about_id ?>" class="btn btn-danger " onclick="return confirm('Ingin Kembali?')">Back</a>
				</div>
				</form>
			</div>
