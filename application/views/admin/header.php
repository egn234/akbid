	...
	<div class="wrapper">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="<?= base_url() ?>admin/dashboard" class="brand-link">
				<img src="<?= base_url(); ?>upload/akbid_logo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
			...
			<div class="sidebar">
				...
				<div class="user-panel mt-3 pb-3 mb-3 d-flex">
					...
					<div class="info">
						<a href="<?= base_url() ?>admin/profile/detail/<?= $s_user->username ?>">
               ...
               with font-awesome or any other icon font library -->
						...
						<li class="nav-item">
							<a id="about" href="<?= base_url(); ?>admin/about" class="nav-link">
