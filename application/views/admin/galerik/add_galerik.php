  <div class="content-wrapper">
  	...
  	<div class="content-header">
  		<div class="container-fluid">
  			<div class="row mb-2">
  				<div class="col-sm-6">
  					<h1 class="m-0 text-dark">Tambah Foto Galeri Kegiatan</h1>
  				</div><!-- /.col -->
  				<div class="col-sm-6">
  					<ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?=base_url()?>admin/dashboard">Home</a></li>
              <li class="breadcrumb-item"><a href="<?=base_url()?>admin/act_gallery">Galeri Kegiatan</a></li>
  	...
  	<section class="content">
  		<div class="container-fluid">
            ...
            <form id="addGalerik" class="form" action="<?=base_url()?>admin/act_gallery/add_proc" method="POST" enctype="multipart/form-data">
