			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item active">Ubah Pencapaian</li>
					</ol>
				</div><!-- /.col -->
			</div><!-- /.row -->
		</div><!-- /.container-fluid -->
					...
					<form class="form-horizontal" method="POST" action="<?= base_url(); ?>admin/pencapaian/edit_pencapaian" enctype="multipart/form-data">
						<div class="card-body">
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<textarea id="desc_kerja_sama" name="deskripsi_pencapaian" required><?= $data[0]->deskripsi_pencapaian ?></textarea>
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-10">
									...
									<?php if (isset($data[0]->foto)) { ?>
										<img src="<?= base_url(); ?>upload/pencapaian/<?= $data[0]->foto ?>" height='90'>
									<?php } ?>
								</div>
							</div>
							<div class="form-group row">
