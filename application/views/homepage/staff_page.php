	...
	<div class="page-section">
		<div class="container">
			...
			<div class="container">
				<div class="row">
					<ul class="list-group">
						<li class="list-group-item border-0">Daftar Staff yang mengajar di Akademi Kebidanan <b>(Klik Nama Untuk Melihat Detail)</b>:</li>
					</ul>
				</div>
			</div>
			<?php
			...
			?>
					<div class="container">
						<div class="row">
							...
							<ul class="list-group">
								<li class="list-group-item border-right-0 border-left-0 border-0 text-lg"><span data-toggle="modal" data-target="#myModal" data-id="<?= $data->staff_id; ?>"> <?= $data->nama; ?></span></li>
							</ul>
						</div>
					</div>
			<?php $start = 1 + $start;
